...
/* var sorted = this.lista.sort(function(a, b){
    return a.total - b.total
}) 

console.log(this.lista)
//console.log(sorted)
maiorValor.innerText = 'Preço Unitário mais Alto ➜ R$ ' + this.lista[this.lista.length - 1].preco + ' - ' + this.lista[this.lista.length - 1].nome
menorValor.innerText = 'Preço Unitário mais Baixo ➜ R$ ' + this.lista[0].preco + ' - ' + this.lista[0].nome
//qtdProd.innerText = 'Valor da compra mais Alta ➜ R$ ' + sorted[sorted.length - 1].total + ' - ' + sorted[sorted.length - 1].nome
}*/